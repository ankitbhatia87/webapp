...
import { CardCommonData } from "./components/Button/interface";
import Timeline from "./utils/timeline";
import ScrollingText from "./features/ScrollingText";
import {
...
const Home: FC = (): ReactElement => {
  ...
  const cardsData: CardCommonData[] = [
    {
      id: 1,
      icon: <Lottie options={technologyLottieOptions} height={100} width={100} />,
      heading: "Technical Expertise",
      text: "Proficient in HTML, CSS, and JavaScript, I design intuitive, visually appealing interfaces."
    },
    {
      id: 2,
      icon: <Lottie options={teamworkLottieOptions} height={100} width={100} />,
      heading: "Teamwork",
      text: "Whether leading or contributing, I foster collaboration and continuous improvement."
    },
    {
      id: 3,
      icon: <Lottie options={resultOrientedLottieOptions} height={100} width={100} />,
      heading: "Result Oriented",
      text: "My problem-solving skills and efficient team management drive progress."
    },
    {
      id: 4,
      icon: <Lottie options={qualityPerformanceLottieOptions} height={100} width={100} />,
      heading: "Quality & Performance",
      text: "I ensure top-tier development with meticulous detail."
    }
  ];
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="px-6 lg:px-32 py-6 lg:py-16 grid gap-6 lg:gap-8 md:grid-cols-2 xl:grid-cols-4 bg-slate-200"
      >
      ...
      <div className="flex justify-center items-center flex-col relative">
        ...
        <h4 className="font-euclidCircularBRegular text-zinc-400">Life in a nutshell</h4>
